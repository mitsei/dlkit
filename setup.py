...
setup(
    ...
    url='https://github.com/mitsei/dlkit',

    # Author details
    author='MIT ODL, SEI',
    author_email='dlkit@mit.edu',
    ...
    packages=find_packages(exclude=['contrib', 'dist', 'dlkit.egg-info',
                                    'docs', 'tests']),
    ...
    package_data={
        'dlkit': ['records/osid/transcript_template.xml']
    },
