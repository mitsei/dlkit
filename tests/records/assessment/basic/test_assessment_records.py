...
class TestPreviousButtonAssessmentOfferedRecord(unittest.TestCase):
    """Tests for PreviousButtonAssessmentOfferedRecord"""
    ...
    def setUp(self):
        self.prev_button_object = PreviousButtonAssessmentOfferedRecord(self.osid_object)
    ...
    def test_get_unlock_previous_throws_exception_if_no_unlock_previous(self):
        ...
        osid_object = OsidObject(object_name='TEST_OBJECT',
                                 osid_object_map=obj_map)
        prev_button_object = PreviousButtonAssessmentOfferedRecord(osid_object)
        with self.assertRaises(errors.IllegalState):
...
class TestPreviousButtonAssessmentOfferedFormRecord(unittest.TestCase):
    """Tests for PreviousButtonAssessmentOfferedFormRecord"""
    ...
    def setUp(self):
        self.form = PreviousButtonAssessmentOfferedFormRecord(self.osid_object_form)
