...
from ..osid.osid_errors import IllegalState,\
    Unimplemented, InvalidArgument, NoAccess, NullArgument, OperationFailed
from .aws_utils import get_aws_s3_handle, get_signed_url
...
class AssetContentForm(abc_repository_objects.AssetContentForm,
    ...
    def set_url(self, url=None):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        """
        raise NoAccess('Use set_data() only. URLs for AWS AssetContents ' +
    ...
    def clear_url(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        """
        raise NoAccess('Use clear_data() only. URLs for AWS AssetContents ' +
                       'are managed by the system')
