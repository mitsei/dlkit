...
class LearningManager(abc_learning_managers.LearningManager, osid_managers.OsidManager, LearningProfile):
    ...
    def get_objective_lookup_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveLookupSession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_query_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveQuerySession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_query_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveQuerySession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_search_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveSearchSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_search_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveSearchSession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_admin_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveAdminSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_admin_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveAdminSession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_hierarchy_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveHierarchySession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_hierarchy_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveHierarchySession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_hierarchy_design_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveHierarchyDesignSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_hierarchy_design_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveHierarchyDesignSession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_sequencing_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveSequencingSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_objective_bank_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveObjectiveBankSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_objective_bank_assignment_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveObjectiveBankAssignmentSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_requisite_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveRequisiteSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_requisite_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveRequisiteSession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_requisite_assignment_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveRequisiteAssignmentSession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_activity_lookup_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ActivityLookupSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_activity_lookup_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ActivityLookupSession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_activity_query_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ActivityQuerySession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_activity_query_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ActivityQuerySession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_activity_search_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ActivitySearchSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_activity_search_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ActivitySearchSession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_activity_admin_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ActivityAdminSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_activity_admin_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ActivityAdminSession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_activity_objective_bank_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ActivityObjectiveBankSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_activity_objective_bank_assignment_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ActivityObjectiveBankAssignmentSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_proficiency_lookup_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ProficiencyLookupSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_proficiency_lookup_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ProficiencyLookupSession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_proficiency_query_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ProficiencyQuerySession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_proficiency_query_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ProficiencyQuerySession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_proficiency_search_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ProficiencySearchSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_proficiency_search_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ProficiencySearchSession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_proficiency_admin_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ProficiencyAdminSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_proficiency_admin_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ProficiencyAdminSession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_proficiency_objective_bank_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ProficiencyObjectiveBankSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_proficiency_objective_bank_assignment_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ProficiencyObjectiveBankAssignmentSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_my_learning_path_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.MyLearningPathSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_learning_path_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.LearningPathSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_learning_path_session_for_objective_bank(self, objective_bank_id=None):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.LearningPathSession(objective_bank_id)
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_bank_lookup_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveBankLookupSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_bank_query_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveBankQuerySession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_bank_search_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveBankSearchSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_bank_admin_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveBankAdminSession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_bank_hierarchy_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveBankHierarchySession()
        except AttributeError:
            raise OperationFailed()
        return session
    ...
    def get_objective_bank_hierarchy_design_session(self):
        ...
        try:
            ...
            raise OperationFailed()
        try:
            session = sessions.ObjectiveBankHierarchyDesignSession()
        except AttributeError:
            raise OperationFailed()
        return session
